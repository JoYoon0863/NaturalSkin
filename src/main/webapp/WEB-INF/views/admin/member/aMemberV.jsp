...
<body>
	...
	<form action="memberInformationUpdate">
		<div id="first-div">
			<label>아이디</label><br>
			<input id="member_id" name="member_id" value="${memberDto.member_id }" readonly style="border:none">
		</div><br>
		<label>비밀번호</label><br>
		<input id="member_pw" name="member_pw" value="${memberDto.member_pw }" type="text"><br>
		<label>이름</label><br>
		...
		<label>이메일</label><br>
		<input id="member_email" name="member_email" value="${memberDto.member_email }" type="email"><br>
		<hr class="second-hr" style="border: solid 1px;">
		<div id="btns">
			<button type="button" onclick="window.close()">취소</button>
			<button type="submit">수정</button>
			<button type="button" onclick="window.open('aMemberAlert?member_id=${ memberDto.member_id }','','width=600, height=200');">회원탈퇴</button>
		</div>
	</form>
</body>
</html>