...
<body>
	...
	<table class="order">
		...
		<tr>
			<td><img id="img" class="orderImg" src=""></td>
			<td><input type="text" id="productName" name=productName style="background-color: white;text-align: center;"></td>
			<td><input type="text" id="amount" name=amount style="background-color: white; text-align: center;"></td>
			<td><input type="text" id="price" name=price style="background-color: white;text-align: center;"></td>
		</tr>
		<tr>
			<td></td>
			<td></td>
	...
	<table class="payment">
		...
		<tr>
			<th>총 결제 금액</th>
			<td><input type="text" id="sum" name=sum style="background-color: white;"></td>
		</tr>
	</table>
	<div id="btns">
...
var productPrice = opener.document.getElementById("productPrice").value;
var amount = opener.document.getElementById("productCount").value;
var name = opener.document.getElementById("productName").value;
var img = opener.document.getElementById("productImg").value;
var product_id = opener.document.getElementById("product_id").value;
...
document.getElementById('total').value = productPrice*amount;
document.getElementById('sum').value = productPrice*amount +2500;
