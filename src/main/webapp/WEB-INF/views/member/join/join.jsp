...
<body>
	...
	<div class="checkBox_group">
      <div>
      	<div class="agree"><input class="checkAll" name="agree" value='checkAll' type="checkbox" onclick="checkAll(this)">이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택)에 모두 동의합니다.</div>
      	<p style="clear: both; font-size: 1px">&nbsp;</p>
        <div class="agree"><input class="check" name="agree" type="checkbox">이동약관 동의(필수)</div>
        <p style="clear: both; font-size: 1px">&nbsp;</p>
...
(시행일) 위 약관은 200*년 **월 **일 부터 시행합니다.</textarea></div>          
        ...
        <div>
        <div class="agree"><input class="check" name="agree" type="checkbox">개인정보 수집 및 이용 동의(필수)</div>
        <p style="clear: both; font-size: 1px">&nbsp;</p>
        <div><textarea name="" id="" cols="30" rows="10">
::: 개인정보취급방침 ::::
...
시행일자 : 200 년 OO월 OO일
        ...
        <div>
	        <div class="agree"><input name="agree" type="checkbox">위치정보 이용약관 동의(선택)</div>
	        <p style="clear: both; font-size: 1px">&nbsp;</p>
	        <div><textarea name="" id="" cols="30" rows="10">
...
회사는 다음과 같이 위치정보 관리책임자를 지정하여 이용자들이 서비스 이용과정에서 발생한 민원사항 처리를 비롯하여 개인위치정보 주체의 권리 보호를 위해 힘쓰고 있습니다.
    ...
    <div id="btns">
    	<button type="button" onclick="agree();">확인</button>
