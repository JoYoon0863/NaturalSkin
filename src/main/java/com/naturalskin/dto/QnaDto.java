...
public class QnaDto {
	...
	String member_id;
	int product_id;
	String qna_board_type;
	String qna_board_title;
	Date qna_board_date;
	String qna_board_content;
	int qna_board_group_no;
	int qna_board_lock;
	int qna_board_reply_state;
	int qna_board_hit;
	...
	public QnaDto(int qna_board_id, String member_id, int product_id, String qna_board_type, String qna_board_title,
			Date qna_board_date, String qna_board_content, int qna_board_group_no, int qna_board_lock,
			int qna_board_reply_state, int qna_board_hit) {
		super();
